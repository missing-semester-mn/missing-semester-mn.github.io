...
Та эдгээр болон бусад сигналуудын талаар [эндээс](https://en.wikipedia.org/wiki/Signal_%28IPC%29) эсвэл [`man signal`](https://www.man7.org/linux/man-pages/man7/signal.7.html), `kill -l` командаар дэлгэрүүлж үзнэ үү.
